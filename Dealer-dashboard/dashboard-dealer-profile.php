    ...
    <nav class="navbar navbar-expand-md fixed-top scrolling-navbar bg-white">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <li class="nav-item">
              <a class="nav-link page-scroll" href="dashboard-dealer.php">Back</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
      <div class="">
        ...
        <?php
                                    ...
                                    $fetchquery = "select * from dealer_registration where Email='$id'";
            ...
            <center><div class="col-md-12">
                        ...
                        <div class="blog-item-wrapper">
                            ...
                            <a href="">
                                <center><img src="<?php if(isset($rowresult[11])){echo $rowresult[11];}else{echo "Uploads/Ano_Male.png";}?>" alt="" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); height: 200px; width: 200px; border-radius: 999px;"></center>
                            </a>
                            </div>
                            ...
                            <div>
                                ...
                                <h6>
                                    ...
                                    Store Name: <?php echo $rowresult[3]; ?><br><br>
                                    Email: <?php echo $rowresult[4]; ?><br><br>
                                    Contact_no: <?php echo $rowresult[5]; ?><br><br>
                                    Alternate Contact_no: <?php echo $rowresult[6]; ?><br><br>
                                    Birthdate: <?php if(isset($rowresult[7])){echo $rowresult[7];}else{echo "Not set";} ?><br><br>
                                </h6>
                                <hr>
                            </div>
                            <div class="meta-tags">
                                <center><a href="dashboard-dealer-updateprofile.php" class="btn btn-lg btn-common btn-effect wow" data-wow-delay="0.9s">Update Profile</a></center>
                            </div>
                            <div class="meta-tags">
                                <center><a href="dashboard-dealer-changepassword.php" class="btn btn-lg btn-common btn-effect wow" data-wow-delay="0.9s">Change password</a></center>
                            </div>
                            <div class="meta-tags">
                              ...
                              if(!file_exists($target_file))
                              {
                                if($_FILES['profile']['type'] == 'image/jpg' || $_FILES['profile']['type'] == 'image/jpeg' || $_FILES['profile']['type'] == 'image/png')
                                {
                                  if(move_uploaded_file($_FILES['profile']['tmp_name'], $target_file))
                                  {
                                    ...
                                    $equery = "update dealer_registration set Profile_photo='$eprofile' where Email='$id'";
