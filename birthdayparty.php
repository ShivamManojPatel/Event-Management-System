...
<head>
    ...
    <title>#Events-Birthday Party</title>
                    ...
                    <ul class="navbar-nav mr-auto w-100 justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link page-scroll" href="" data-toggle="modal"
                                data-target="#modalmanageprofile">Manage
                                Profile</a>
                        </li>
                        <li class="nav-item">
    ...
    <section id="portfolios" class="section">
        ...
        <div class="container">
            <div class="section-header">
                <h2 class="section-title">Birthday Party</h2>
                <span>Birthday</span>
            ...
            <div id="portfolio" class="row">
                <div class="col-lg-4 col-md-6 col-xs-12 mix development print">
                    <div class="portfolio-item">
                        <div class="shot-item">
                            <img src="img/birthday party/catring1.jpg" alt="" />
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 mix design print">
                    <div class="portfolio-item">
                        <div class="shot-item">
                            <img src="img/birthday party/b7.jpg" alt="" />
                            <div class="single-content">
                                <div class="fancy-table">
                                    <div class="table-cell">
                                        <div class="zoom-icon">
                                            <a class="lightbox" href="img/birthday party/b7.jpg"><i
                                                    class="lni-zoom-in item-icon"></i></a>
                                        </div>
                                        <a href="#">View Project</a>
                                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 mix development">
                    <div class="portfolio-item">
                        <div class="shot-item">
                            <img src="img/birthday party/catring3.jpg" alt="" />
                            <div class="single-content">
                                <div class="fancy-table">
                                    <div class="table-cell">
                                        <div class="zoom-icon">
                                            <a class="lightbox" href="img/birthday party/catring3.jpg"><i
                                                    class="lni-zoom-in item-icon"></i></a>
                                        </div>
                                        <a href="#">View Project</a>
                                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 mix development design">
                    <div class="portfolio-item">
                        <div class="shot-item">
                            <img src="img/birthday party/catring2.jpg" alt="" />
                            <div class="single-content">
                                <div class="fancy-table">
                                    <div class="table-cell">
                                        <div class="zoom-icon">
                                            <a class="lightbox" href="img/birthday party/catring2.jpg"><i
                                                    class="lni-zoom-in item-icon"></i></a>
                                        </div>
                                        <a href="#">View Project</a>
                                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 mix development">
                    <div class="portfolio-item">
                        <div class="shot-item">
                            <img src="img/birthday party/catring6.jpg" alt="" />
                            <div class="single-content">
                                <div class="fancy-table">
                                    <div class="table-cell">
                                        <div class="zoom-icon">
                                            <a class="lightbox" href="img/birthday party/catring6.jpg"><i
                                                    class="lni-zoom-in item-icon"></i></a>
                                        </div>
                                        <a href="#">View Project</a>
                                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 mix print design">
                    <div class="portfolio-item">
                        <div class="shot-item">
                            <img src="img/birthday party/b9.jpg" alt="" />
                            <div class="single-content">
                                <div class="fancy-table">
                                    <div class="table-cell">
                                        <div class="zoom-icon">
                                            <a class="lightbox" href="img/birthday party/b9.jpg"><i
                                                    class="lni-zoom-in item-icon"></i></a>
                                        </div>
                                        <a href="#">View Project</a>
                                    </div>
                        ...
                        <div class="contact-block">
                            <form id="contactForm">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" placeholder="Enter Contact Number" id="contactno"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="bdayguyname" name="bdayguyname"
                                                placeholder="Name of the Birthday Guy" required
                                                data-error="Please enter the name of birthday guy">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="peoplecount" name="peoplecount"
                                                ...
                                                data-error="Please enter Number of people you want to invite">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="form-control" id="package" name="package" required
                                                data-error="Please select your package" style="height: 53px;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <textarea class="form-control" id="message" placeholder="Any suggession"
                                                rows="2" data-error="Write your message"></textarea>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                        <div class="submit-button">
                                            <button class="btn btn-common btn-effect" id="submit" type="submit">Book
                                                Event</button>
