    ...
    <body>
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container-fluid">
                    <center><h1 class="mt-4">Admins</h1></center><br>
                    <form method='post'><input type='submit' class='btn btn-primary' name='btnaddadmin' value="Add Admin"></form>
                    <hr>
                    <?php if(isset($_COOKIE['msg'])){ echo "<center><div style='padding: 0px; background-color: lightgreen; color: black; height: 25px; width: 50%; border-radius: 99px;'>";?><?php echo $_COOKIE['msg']; ?><?php echo "</div><br><center>";}?>
                    <center><h1 class='mt-4'>Active Admins</h1></center>
                    <div class='table-wrapper'>
                    <?php
                        $query = "select * from admin_registration where Status='Active'";
                        ...
                        if(mysqli_affected_rows($conn) > 0)
                        {
                            ...
                            <table class="table table-borderless table-wrapper">
                                <thead>
                                    ...
                                    <th style="background-color: white;">Contact</th>
                                    ...
                                    <?php
                                        while($row = mysqli_fetch_array($result))
                                        {
                                            ?>
                                                ...
                                                <td><form method='post' action="Admininactive.php?id=<?php echo $row[0];?>"><input type='submit' value='Inactive' class="btn btn-danger"></form></td>
                                                </tr>
                                            <?php
                                        }
                                    ?>
                    ...
                    <hr>
                    <center><h1 class='mt-4'>Inactive Admins</h1></center>
                    <div class='table-wrapper'>
                    <?php
                        $iquery = "select * from admin_registration where Status='Inactive'";
                                    ...
                                    <?php
                                        while($row = mysqli_fetch_array($iresult))
                                        {
                                            ?>
                                                ...
                                                <td><?php echo $row[4]; ?></td>
                                                <td><?php echo $row[5]; ?></td>
                                                <td><form method='post' action="Adminactive.php?id=<?php echo $row[0];?>"><input type='submit' value='Active' class="btn btn-success"></form></td>
                                                </tr>
                                            <?php
                                        }
                                    ?>
