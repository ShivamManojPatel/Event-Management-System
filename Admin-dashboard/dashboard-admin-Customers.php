<?php 
  ...
  session_start();
   ...
   {
    header('location: dashboard-admin-Customers;');
   }
?>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="dashboard-admin-Customers.php" style='color: black;'>Customers</a>
            ...
            <div id="page-content-wrapper">
                ...
                <hr>
                <center><h1 class="mt-4">Active Customers Details</h1></center><br><br>
                        ...
                        <?php
                            ...
                            if(!isset($_POST['searchbtn']))
                            {
                                ...
                                <table class="table table-borderless table-wrapper">
                                        <?php
                                            $query = "select * from registration_master where Status='Active'";
                                            ...
                                            if(mysqli_affected_rows($conn) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_array($result))
                                                {
                                                    ?>
                                                        ...
                                                        <td><form method='post' action="delete.php?id=<?php echo $row[0]; ?>"><input type='submit' value='Inactive' class="btn btn-danger"></form></td>
                                                        </tr>
                                                    <?php
                                                }
                                            }
                            ...
                            else
                            {
                                ...
                                <table class="table table-borderless table-wrapper">
                                        ...
                                        {
                                            $Email = $_POST['search'];
                                            $query = "select * from registration_master where Status='Active' and Email='$Email'";
                                            $result = mysqli_query($conn, $query);
                    ...
                    <hr>
                    <center><h1 class="mt-4">Inactive Customers Details</h1></center><br><br>
                    <div class='table-wrapper'>
                    <center>
                            <form method="post">
                        ...
                        <?php
                            if(!isset($_POST['Isearchbtn']))
                            {
                                ...
                                <table class="table table-borderless table-wrapper">
                                        <?php
                                            $query = "select * from registration_master where Status='Inactive'";
                                            $result = mysqli_query($conn, $query);
                                            ...
                                            if(mysqli_affected_rows($conn) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_array($result))
                                                {
                                                    ?>
                                                        ...
                                                        <td><?php echo $row[4]; ?></td>
                                                        <td><?php echo $row[7]; ?></td>
                                                        <td><form method='post' action="Active.php?id=<?php echo $row[0]; ?>"><input type='submit' value='Active' class="btn btn-success"></form></td>
                                                        </tr>
                                                    <?php
                                                }
                                            }
                            ...
                            else
                            {
                                ...
                                <table class="table table-borderless table-wrapper">
                                        ...
                                        {
                                            $Email = $_POST['Isearch'];
                                            $query = "select * from registration_master where Status='Inactive' and Email='$Email'";
                                            $result = mysqli_query($conn, $query);
